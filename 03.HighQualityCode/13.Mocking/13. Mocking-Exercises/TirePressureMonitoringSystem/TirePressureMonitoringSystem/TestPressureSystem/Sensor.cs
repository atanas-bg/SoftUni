namespace TestPressureSystem
{
    ...
    public class Sensor : ICheckable
    {
        //
        ...
        private double ReadPressureSample()
        {
            ...
            var pressureSampleResult = 6 * this._randomPressureSampleSimulator.NextDouble() *
                this._randomPressureSampleSimulator.NextDouble();

            return pressureSampleResult;
        }
    }
}
