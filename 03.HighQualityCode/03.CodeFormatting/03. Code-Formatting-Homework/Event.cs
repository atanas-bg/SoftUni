...
class Event : IComparable
{
    ...
    {
        Event objectEvent = objectToCompare as Event;
        int byDate = this.date.CompareTo(objectEvent.date);
        int byTitle = this.title.CompareTo(objectEvent.title);
        int byLocation = this.location.CompareTo(objectEvent.location);
...
class Program
{
    static StringBuilder outputEvents = new StringBuilder();

    static class Messages
    {
        public static void EventAdded()
        {
            outputEvents.Append("Event added\n");
        }

        public static void EventDeleted(int eventsDeletedNumber)
        {
            if (eventsDeletedNumber == 0)
            {
                NoEventsFound();
            }
            else
            {
                outputEvents.AppendFormat("{0} events deleted\n", eventsDeletedNumber);
            }
        }

        public static void NoEventsFound()
        {
            outputEvents.Append("No events found\n");
        }
        ...
        public static void PrintEvent(Event eventToPrint)
        {
            ...
            {
                outputEvents.Append(eventToPrint + "\n");
            }
        }
    }
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(outputEvents);
    }
